// js/config/heroes-data.js -- Hero data (extracted from heroes.js)
// This file contains ONLY data definitions. Logic remains in systems/heroes.js.
// Loaded before all other scripts via <script> tag.
...
window.AFFINITIES_DATA = [
  { id: 'taoyuan', name: '桃园三兄弟', heroes: ['liubei', 'guanyu', 'zhangfei'], emoji: '桃', desc: '桃园结义，生死与共', bonus: { all_pct: 20 }, bonusDesc: '全属性+20%', minRequired: 3 },
  { id: 'wolong_fengchu', name: '卧龙凤雏', heroes: ['zhugeLiang', 'pangtong'], emoji: '龙', desc: '卧龙凤雏得一可安天下', bonus: { int_pct: 30 }, bonusDesc: 'INT+30%', minRequired: 2 },
  { id: 'tiger_wall', name: '虎将双壁', heroes: ['zhaoyun', 'machao'], emoji: '虎', desc: '常山赵子龙与锦马超的合击', bonus: { atk_pct: 25 }, bonusDesc: 'ATK+25%', minRequired: 2 },
  { id: 'fire_duo', name: '江东火计', heroes: ['zhouyu', 'luxun'], emoji: '火', desc: '赤壁之火与夷陵之焰', bonus: { fire_dmg_pct: 30 }, bonusDesc: '火焰伤害+30%', minRequired: 2 },
  { id: 'wu_tiger', name: '五虎上将', heroes: ['guanyu', 'zhangfei', 'zhaoyun', 'machao', 'huangzhong'], emoji: '将', desc: '蜀汉五虎大将齐聚', bonus: { atk_pct: 15, def_pct: 15 }, bonusDesc: 'ATK+15%, DEF+15%', minRequired: 3 },
  { id: 'wei_advisors', name: '魏之双璧', heroes: ['simayi', 'guojia'], emoji: '谋', desc: '曹魏最强谋士组合', bonus: { int_pct: 25 }, bonusDesc: 'INT+25%', minRequired: 2 },
  { id: 'wu_pillars', name: '吴国柱石', heroes: ['zhouyu', 'lusu', 'luxun'], emoji: '柱', desc: '东吴三任大都督', bonus: { all_pct: 10, int_pct: 15 }, bonusDesc: '全属性+10%, INT+15%', minRequired: 2 },
  { id: 'beauty', name: '绝代双骄', heroes: ['diaochan', 'zhenji'], emoji: '美', desc: '倾国倾城，四大美女其二', bonus: { int_pct: 20, spd_pct: 15 }, bonusDesc: 'INT+20%, SPD+15%', minRequired: 2 },
  { id: 'nanman', name: '南蛮双雄', heroes: ['menghuo', 'zhurong'], emoji: '蛮', desc: '南蛮王与火神后裔', bonus: { hp_pct: 20, atk_pct: 15 }, bonusDesc: 'HP+20%, ATK+15%', minRequired: 2 },
  { id: 'heir', name: '继志北伐', heroes: ['zhugeLiang', 'jiangwei'], emoji: '继', desc: '诸葛亮与其衣钵传人', bonus: { int_pct: 20, atk_pct: 10 }, bonusDesc: 'INT+20%, ATK+10%', minRequired: 2 },
];
