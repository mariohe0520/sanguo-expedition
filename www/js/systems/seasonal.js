  ...
  SEASONS: [
    {
      ...
      desc: '桃花盛开，英雄相聚',
      theme: 'shu',
      bannerHeroes: ['liubei', 'guanyu', 'zhangfei', 'zhaoyun', 'huangzhong'],
    ...
    },
    {
      ...
      desc: '烈日炎炎，烽火燃江',
      theme: 'wu',
      bannerHeroes: ['zhouyu', 'luxun', 'sunshangxiang'],
    ...
    },
    {
      ...
      desc: '秋风瑟瑟，壮志未酬',
      theme: 'wei',
      bannerHeroes: ['caocao', 'simayi', 'caoren'],
      boostedRates: { 5: 0.05, 4: 0.15 },
    ...
    },
    {
      ...
      desc: '寒冬凛冽，群雄割据',
      theme: 'qun',
      bannerHeroes: ['lvbu', 'diaochan', 'zhangjiao'],
