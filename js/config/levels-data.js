// js/config/levels-data.js -- Campaign chapter/stage data (extracted from campaign.js)
// This file contains ONLY data definitions. Logic remains in systems/campaign.js.
...
window.DESTINY_CHOICES_DATA = {
  1: { trigger_after: 5, title: '天命之选：卢植之危', desc: '恩师卢植被押往洛阳受刑。你可以冒险去救，或趁乱南下扩张势力。', options: [ { id: 'A', text: '救！恩师之恩不可忘', desc: '冒险营救卢植，获得忠义值和新武将线索', reward: { loyalty: 50, hero_hint: 'guanyu' }, stages: [6, 7] }, { id: 'B', text: '先壮大自己再说', desc: '南下招兵买马，获得更多金币和兵力', reward: { gold: 500, troops: 100 }, stages: [8, 9] } ], lore: '选择塑造命运。没有对错，只有不同的三国。' },
  2: { trigger_after: 5, title: '天命之选：虎牢关之岔', desc: '吕布退走，关外百姓正遭劫掠。追击吕布可削其势，救助百姓可得民心。', options: [ { id: 'A', text: '救！百姓为重', desc: '护送百姓撤离，获得民心值和名医线索', reward: { loyalty: 80, hero_hint: 'huatuo' }, stages: [6, 7] }, { id: 'B', text: '追！斩草除根', desc: '穷追吕布，获得战利品和精锐装备', reward: { gold: 800, equip_hint: 'fangtian_halberd' }, stages: [8, 9] } ], lore: '仁者救人，勇者杀敌。虎牢关下，你的选择将改变天命。' },
  3: { trigger_after: 5, title: '天命之选：赤壁之谋', desc: '曹仁已退，曹军大营就在江对岸。周瑜献火攻之计，庞统献铁索连环。然火攻虽猛，江边百姓恐遭殃及。', options: [ { id: 'A', text: '火攻！借东风焚尽曹船', desc: '火烧连环船，造成毁灭性打击，但沿江村落难免波及', reward: { atk_bonus: 30, karma: -20 }, stages: [6, 7] }, { id: 'B', text: '水路封锁，困死曹军', desc: '切断补给水路，迫曹军不战自溃。耗时更长但保全百姓', reward: { loyalty: 100, def_bonus: 20 }, stages: [8, 9] } ], lore: '火光冲天还是静水流深？赤壁之上，仁与狠一念之间。' },
  4: { trigger_after: 5, title: '天命之选：五丈原的抉择', desc: '孔明病重，星落秋风五丈原。他留下最后一计，施展需燃尽自身生命之火。或可不用此计，以大军正面强攻。', options: [ { id: 'A', text: '施孔明遗计，以命换胜', desc: '使用诸葛亮最后的计谋，威力惊人但主力武将损失大量HP', reward: { int_bonus: 40, hero_cost: { stat: 'hp', pct: -30 } }, stages: [6, 7] }, { id: 'B', text: '正面强攻，堂堂正正', desc: '不靠奇谋，以绝对兵力碾压。战斗更难但无额外代价', reward: { atk_bonus: 25, gold: 1500 }, stages: [8, 9] } ], lore: '鞠躬尽瘁，死而后已。丞相的遗志，由你来完成。' },
  5: { trigger_after: 5, title: '天命之选：夷陵之火', desc: '关羽已逝，张飞遇害。刘备怒火中烧，率蜀军倾巢东征。陆逊坚守不出，七百里连营暴露在山林之间。是继续复仇的烈焰，还是收拾残局、守住蜀汉根基？', options: [ { id: 'A', text: '复仇！关羽之仇不共戴天', desc: '全军猛攻，ATK+40但随机2名武将因负伤退出3场战斗', reward: { atk_bonus: 40, hero_disable: { count: 2, battles: 3 } }, stages: [6, 7] }, { id: 'B', text: '放下，重建蜀汉', desc: '接受失去，凝聚人心。忠义+150，解锁特殊阵型「桃园阵」', reward: { loyalty: 150, unlock_formation: 'taoyuan_formation' }, stages: [8, 9] } ], lore: '烈火焚林还是落叶归根？夷陵之上，蜀汉的命运悬于一念。' },
  6: { trigger_after: 5, title: '天命之选：北伐的命脉', desc: '姜维继承丞相遗志北伐中原，然蜀道艰难，粮草补给成为最大瓶颈。木牛流马可保后勤无忧，全面进攻则可毕其功于一役——但粮尽之日便是败亡之时。', options: [ { id: 'A', text: '木牛流马，稳扎稳打', desc: '建造木牛流马保障补给，金+2000，获得后勤增益', reward: { gold: 2000, logistics_buff: true }, stages: [6, 7] }, { id: 'B', text: '全面进攻，一战定乾坤', desc: 'ATK+35，士气+50，但补给消耗翻倍', reward: { atk_bonus: 35, morale: 50, supply_penalty_multiplier: 2 }, stages: [8, 9] } ], lore: '兵马未动粮草先行。北伐之路，是稳如泰山还是破釜沉舟？' },
  7: { trigger_after: 5, title: '天命之选：乌巢之火', desc: '袁绍大军压境，兵力悬殊。许攸来降，献计奇袭乌巢粮仓。烧毁粮草可令袁军不战自溃，但也可凭曹军精锐正面击溃袁军主力。', options: [ { id: 'A', text: '火烧乌巢，奇兵制胜', desc: '夜袭乌巢粮仓，釜底抽薪。获得大量金币和谋士增益', reward: { gold: 3000, int_bonus: 30 }, stages: [6, 7] }, { id: 'B', text: '正面决战，以力破力', desc: '堂堂正正击溃袁军主力，ATK+35，获得精锐装备线索', reward: { atk_bonus: 35, equip_hint: 'guanyu_blade' }, stages: [8, 9] } ], lore: '以少胜多，是智者之道还是勇者之路？官渡一役，天下归属由此而定。' },
  8: { trigger_after: 5, title: '天命之选：合肥攻守', desc: '孙权十万大军兵临合肥城下，张辽仅有七千守军。是凭坚城死守消耗吴军，还是主动出击以攻代守？', options: [ { id: 'A', text: '死守城池，以逸待劳', desc: '依托城防消耗吴军，DEF+40，获得铁壁增益', reward: { def_bonus: 40, loyalty: 120 }, stages: [6, 7] }, { id: 'B', text: '主动出击，八百破十万', desc: '效仿张辽逍遥津之勇，ATK+35，SPD+20', reward: { atk_bonus: 35, spd_bonus: 20 }, stages: [8, 9] } ], lore: '守如磐石还是攻如烈火？合肥城下，勇气与智慧的终极抉择。' },
  9: { trigger_after: 5, title: '天命之选：定军山之策', desc: '夏侯渊据守定军山，地势险要。法正献策可夜袭山顶居高临下，黄忠请战正面猛攻。山路崎岖，奇袭风险与收益并存。', options: [ { id: 'A', text: '奇袭山顶，居高临下', desc: '夜间攀登，占据制高点。INT+35，获得地形优势增益', reward: { int_bonus: 35, terrain_buff: 'mountain_advantage' }, stages: [6, 7] }, { id: 'B', text: '围而不攻，断其粮道', desc: '切断补给，困死敌军。金+4000，获得后勤增益', reward: { gold: 4000, logistics_buff: true }, stages: [8, 9] } ], lore: '兵法云：攻其不备，出其不意。定军山上，老将黄忠的一刀将改写历史。' },
  10: { trigger_after: 5, title: '天命之选：天下归属', desc: '三国鼎立数十年，司马昭已掌魏国大权。蜀汉、东吴日薄西山。是举全力兴复汉室，逆天改命？还是顺应天命，让天下归于一统？这是最后的抉择。', options: [ { id: 'A', text: '兴复汉室！逆天改命', desc: '燃尽一切，为汉室做最后一搏。全队ATK+50%但HP-20%', reward: { atk_bonus: 50, hero_cost: { stat: 'hp', pct: -20 } }, stages: [6, 7] }, { id: 'B', text: '顺应天命，天下一统', desc: '放下执念，换取和平。忠义+200，全队DEF+30%', reward: { loyalty: 200, def_bonus: 30 }, stages: [8, 9] } ], lore: '天下大势，分久必合。但英雄之心，岂甘沉寂？最终之战，你的选择将决定这个时代的结局。' },
};
