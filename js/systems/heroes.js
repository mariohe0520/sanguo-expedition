// 三国·天命 — Hero Database
// Hero data loaded from config/heroes-data.js (window.HEROES_DATA)
// This file retains unit type definitions, factions, and helper functions.
// 兵种克制: 骑→弓→枪→盾→术→骑
const UNIT_TYPES = {
...
// HEROES data loaded from config/heroes-data.js
...
// Affinity data loaded from config/heroes-data.js (window.AFFINITIES_DATA)
const HERO_AFFINITIES = window.AFFINITIES_DATA || [
  {
    id: 'taoyuan',
    name: '桃园三兄弟',
...
// ===== ELEMENT SYSTEM =====
// Element data loaded from config/heroes-data.js (window.ELEMENTS_DATA)
const HERO_ELEMENTS = window.ELEMENTS_DATA || {
  // Shu
