...
// Equipment template data loaded from config/equipment-data.js (window.EQUIPMENT_DATA)

// ===== EQUIPMENT SYSTEM =====
const Equipment = {
  // Loaded from config/equipment-data.js
  RARITIES: (window.EQUIPMENT_DATA && window.EQUIPMENT_DATA.RARITIES) || {
  ...
  SLOTS: (window.EQUIPMENT_DATA && window.EQUIPMENT_DATA.SLOTS) || {
  ...
  SETS: (window.EQUIPMENT_DATA && window.EQUIPMENT_DATA.SETS) || {
    longdan: {
  ...
  // ===== EQUIPMENT TEMPLATES =====
  // Loaded from config/equipment-data.js
  TEMPLATES: (window.EQUIPMENT_DATA && window.EQUIPMENT_DATA.TEMPLATES) || {
    // ── WEAPONS ──
  ...
  // Drop tables per chapter — loaded from config/equipment-data.js
  DROP_TABLES: (window.EQUIPMENT_DATA && window.EQUIPMENT_DATA.DROP_TABLES) || {
