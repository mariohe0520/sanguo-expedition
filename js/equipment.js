...
const Equipment = {
  ...
  SLOTS: {
    ...
    armor:     { name: '防具', emoji: '🛡️' },
    accessory: { name: '饰品', emoji: '💍' },
    mount:     { name: '坐骑', emoji: '🐴' },
  },
  ...
  TEMPLATES: {
    // ── WEAPONS ──
    iron_sword:     { id:'iron_sword',     name:'铁剑',     slot:'weapon', rarity:1, stats:{atk:8},               emoji:'🗡️' },
    iron_spear:     { id:'iron_spear',     name:'铁枪',     slot:'weapon', rarity:1, stats:{atk:7,hp:20},         emoji:'🗡️' },
    wood_bow:       { id:'wood_bow',       name:'木弓',     slot:'weapon', rarity:1, stats:{atk:6,spd:2},         emoji:'🏹' },
    bronze_blade:   { id:'bronze_blade',   name:'青铜刀',   slot:'weapon', rarity:2, stats:{atk:15,def:3},        emoji:'⚔️' },
    steel_spear:    { id:'steel_spear',    name:'精钢枪',   slot:'weapon', rarity:2, stats:{atk:14,hp:40},        emoji:'⚔️' },
    ...
    sky_blade:      { id:'sky_blade',      name:'倚天剑',   slot:'weapon', rarity:4, stats:{atk:42,int:10,def:8}, emoji:'⚔️' },
    serpent_spear:  { id:'serpent_spear',  name:'丈八蛇矛', slot:'weapon', rarity:4, stats:{atk:48,hp:80},        emoji:'⚔️' },
    ...
    moon_blade:     { id:'moon_blade',     name:'青龙偃月刀',slot:'weapon',rarity:5, stats:{atk:65,def:15,hp:150},emoji:'⚔️' },
    ...
    chain_mail:      { id:'chain_mail',      name:'锁子甲',   slot:'armor', rarity:2, stats:{def:14,hp:60},          emoji:'🛡️' },
    iron_plate:      { id:'iron_plate',      name:'铁甲',     slot:'armor', rarity:2, stats:{def:16,hp:40},          emoji:'🛡️' },
    scale_armor:     { id:'scale_armor',     name:'鱼鳞甲',   slot:'armor', rarity:3, stats:{def:24,hp:100},         emoji:'🛡️' },
    ring_mail:       { id:'ring_mail',       name:'环锁铠',   slot:'armor', rarity:3, stats:{def:22,hp:80,spd:3},    emoji:'🛡️' },
    bright_armor:    { id:'bright_armor',    name:'明光铠',   slot:'armor', rarity:4, stats:{def:38,hp:180,spd:5},   emoji:'🛡️' },
    dark_iron_armor: { id:'dark_iron_armor', name:'玄铁甲',   slot:'armor', rarity:4, stats:{def:45,hp:200},         emoji:'🛡️' },
    tiger_armor:     { id:'tiger_armor',     name:'虎豹铠',   slot:'armor', rarity:5, stats:{def:60,hp:300,atk:15},  emoji:'🛡️' },
    flame_armor:     { id:'flame_armor',     name:'赤焰战甲', slot:'armor', rarity:5, stats:{def:55,hp:250,int:20},  emoji:'🛡️' },
...
const KingdomSystem = {
  KINGDOMS: {
    shu: { name:'蜀汉', faction:'shu', color:'#22c55e', emoji:'🟢', banner:'🐲', desc:'仁义之师，匡扶汉室', buff:'蜀阵营武将全属性+10%' },
    wei: { name:'曹魏', faction:'wei', color:'#3b82f6', emoji:'🔵', banner:'🦅', desc:'唯才是举，雄霸天下', buff:'魏阵营武将全属性+10%' },
    wu:  { name:'东吴', faction:'wu',  color:'#ef4444', emoji:'🔴', banner:'🐯', desc:'据江东之固，观天下变', buff:'吴阵营武将全属性+10%' },
    qun: { name:'群雄', faction:'qun', color:'#a855f7', emoji:'🟣', banner:'🐺', desc:'群雄逐鹿，各为其主', buff:'群阵营武将全属性+10%' },
  },
...
const Achievements = {
  DEFS: [
    { id:'first_stage',    name:'初出茅庐',       desc:'通关第一个关卡',     icon:'⚔️',  reward:{ gold:200 } },
    { id:'first_destiny',  name:'天命之选',       desc:'做出第一个天命抉择', icon:'🌟',  reward:{ gems:10 } },
    { id:'first_recruit',  name:'招贤纳士',       desc:'从求贤馆招募第一位武将', icon:'🏯', reward:{ gold:300 } },
    { id:'collect_5',      name:'五虎上将',       desc:'拥有5名武将',        icon:'🛡️',  reward:{ gems:15 } },
    { id:'collect_10',     name:'千军万马',       desc:'拥有10名武将',       icon:'🏰',  reward:{ gems:30, shards:{ zhaoyun:5 } } },
    { id:'clear_ch1',      name:'黄巾终结者',     desc:'通关第一章',         icon:'⚡',  reward:{ gold:500, gems:5 } },
    { id:'clear_ch2',      name:'虎牢之主',       desc:'通关第二章',         icon:'🏔️',  reward:{ gold:800, gems:10 } },
    { id:'clear_ch3',      name:'赤壁之英',       desc:'通关第三章',         icon:'🔥',  reward:{ gold:1200, gems:15 } },
    { id:'clear_ch4',      name:'五丈原的继承者', desc:'通关第四章',         icon:'📜',  reward:{ gold:1800, gems:20 } },
    { id:'clear_ch5',      name:'夷陵之焰',       desc:'通关第五章',         icon:'🌲',  reward:{ gold:2500, gems:25 } },
    { id:'clear_ch6',      name:'北伐大业',       desc:'通关第六章',         icon:'⛰️',  reward:{ gold:5000, gems:50 } },
    { id:'level_10',       name:'初露锋芒',       desc:'玩家等级达到10级',   icon:'📈',  reward:{ gold:400 } },
    { id:'level_20',       name:'百战之将',       desc:'玩家等级达到20级',   icon:'🎖️',  reward:{ gems:20, shards:{ guanyu:5 } } },
    { id:'win_50',         name:'常胜将军',       desc:'累计赢得50场战斗',   icon:'🏅',  reward:{ gold:1000 } },
    { id:'win_100',        name:'不败之师',       desc:'累计赢得100场战斗',  icon:'👑',  reward:{ gems:30, shards:{ lvbu:3 } } },
    { id:'first_equip',    name:'披挂上阵',       desc:'为武将穿戴第一件装备', icon:'🎒', reward:{ gold:200 } },
    { id:'set_longdan',    name:'龙胆之力',       desc:'集齐龙胆套装4件',     icon:'🐉', reward:{ gems:25 } },
    { id:'set_fengyi',     name:'凤翼之风',       desc:'集齐凤翼套装4件',     icon:'🔥', reward:{ gems:25 } },
    { id:'set_xuanjia',    name:'玄甲之壁',       desc:'集齐玄甲套装4件',     icon:'⬛', reward:{ gems:25 } },
    { id:'pick_kingdom',   name:'效忠之心',       desc:'选择势力阵营',       icon:'🏰',  reward:{ gold:500, gems:10 } },
  ],
